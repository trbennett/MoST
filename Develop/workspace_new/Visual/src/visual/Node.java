 ...
 * 
 */
public class Node extends GraphPanel
{
	private static final long serialVersionUID = 3536472195622776147L;
	 ...
	 * Draw this node.
	 */
	public void draw(Graphics g, boolean visible) {
		...
		/**
		 * Can draw each type of movement as a different shape. Not currently implemented - left out until transitional movements
		 * properly completed.
		 */
		/*
		if(hasDuration && !transitional)
		{
		...
		{
			int xpoints[] = {b.x, b.x+(b.width/2), b.x+b.width};
			int ypoints[] = {b.y+b.height, b.y, b.y+b.height};
